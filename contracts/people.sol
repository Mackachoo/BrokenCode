...
contract Patient {
    ...
    function returnRecord (uint _index) constant returns (string, string) {
...
contract Doctor {
    ...
    address[] patients = [0x627306090abab3a6e1400e9345bc60c78a8bef57];

    function list_patients() public constant returns (address[]) {
        return patients;
    }
}
